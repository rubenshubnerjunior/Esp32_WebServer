...
#### Com o Servidor de página Web vamos enviar para o navegador HTML, JavaScript, CSS, BootStrap, Imagem png.
#### Usaremos o Servidor WebSocket vamos enviar e receber Strings no formato JSON Entre o Esp32 e o Navegador para fazer comandos e exibir os Status no Navegador.
...
#### Quando o navegador faz o Request, o servidor de página Web faz um Response enviando a pasta data para o navegador.
